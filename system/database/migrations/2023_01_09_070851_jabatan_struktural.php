...
class JabatanStruktural extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource("JabatanStruktural");
        $migrate->instance($pathJson);

        Schema::create(strtoupper(from_camel_case('JabatanStruktural')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('JabatanStruktural'));
    }
}
