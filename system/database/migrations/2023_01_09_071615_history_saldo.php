...
class HistorySaldo extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource("HistorySaldo");
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('HistorySaldo')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('HistorySaldo'));
    }
}
