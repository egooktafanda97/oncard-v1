...
class Kantin extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource("Kantin");
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('Kantin')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('Kantin'));
    }
}
