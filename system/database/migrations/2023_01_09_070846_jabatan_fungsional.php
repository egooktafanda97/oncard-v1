...
class JabatanFungsional extends Migration
{
    ...
    public function up()
    {
        ...
        $migrate = new ControlSource("JabatanFungsional");
        $migrate->instance($pathJson);
        Schema::create(strtoupper(from_camel_case('JabatanFungsional')), function (Blueprint $table) use ($migrate) {
    ...
    {
        Schema::dropIfExists(strtoupper('JabatanFungsional'));
    }
}
